...
const Hero = () => {
  return (
    <main className="">
      <div className={`h-[calc(100svh-100px)] flex `}
        style={{
      ...
      >
        <div className="flex flex-col md:flex-row w-full justify-center items-center px-24">
          <div className="flex flex-col justify-center items-start gap-8">
            <span
              className="bg-[#B0FFD3] px-4 py-2 rounded-full leading-loose"
            >
              E-Cure Environment:
            </span>
            <h1
            ...
            >
              A Commitment to <br />
              <span className="text-[#007936]">
                Environemtally Responsible
              </span>
              <br />
              Operations
            </h1>
            <p
              className="overflow-ellipsis w-1/2"
            >
              E-Cure Environment is a privately held company that offers high-quality technical services in environmental consulting, water and wastewater treatment, field sampling, environmental testing, and ETP chemical.
            </p>
            <button
              className="px-5 py-2 bg-[#1B8733] text-white rounded-lg"
            >
              Contact Us
            </button>
          </div>
      ...
      <section className="md:px-24 px-8" id="gallery">
        <Gallery />
      </section>
    </main>
  )
